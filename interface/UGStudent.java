...
class UGStudent extends Student {
    ...
    public UGStudent(int rollno, String name, String address, double weight, double height, double cgpa,
            ArrayList<String> coursesEnrolled, ArrayList<String> arrearCourses) {
        this.rollno = rollno;
        this.name = name;
