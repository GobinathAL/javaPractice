...
class PGStudent extends Student {
    ...
    public PGStudent(int rollno, String name, double cgpa, ArrayList<String> coursesEnrolled, ArrayList<String> arrearCourses, String ugCollegeName) {
        this.rollno = rollno;
        this.name = name;
        this.cgpa = cgpa;
    ...
    public boolean hasEnrolledIn(String course) {
        if(coursesEnrolled.size() == 0) return false;
    ...
    public boolean hasArrearIn(String course) {
        if(arrearCourses.size() == 0) return false;
